        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 mb-16 text-left">
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4 text-[#667069] text-[14px] font-normal">
              <li><Link to="/about" className="hover:text-forest transition-colors leading-[1.8]">About Us</Link></li>
              <li><Link to="/agri-park" className="hover:text-forest transition-colors leading-[1.8]">Agri Park</Link></li>
              <li><Link to="/careers" className="hover:text-forest transition-colors leading-[1.8]">Careers</Link></li>
              <li><Link to="/contact" className="hover:text-forest transition-colors leading-[1.8]">Contact</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4 text-[#667069] text-[14px] font-normal">
              <li><Link to="/services/nursery" className="hover:text-forest transition-colors leading-[1.8]">Bio-Boosted Nursery</Link></li>
              <li><Link to="/services/kisaan-mall" className="hover:text-forest transition-colors leading-[1.8]">Kisaan Mall</Link></li>
              <li><Link to="/services/farm-tech" className="hover:text-forest transition-colors leading-[1.8]">Farm Tech</Link></li>
              <li><Link to="/services/carbon-credits" className="hover:text-forest transition-colors leading-[1.8]">Carbon Credits</Link></li>
              <li><Link to="/services/big-farm-setup" className="hover:text-forest transition-colors leading-[1.8]">Big Farm Setup</Link></li>
              <li><Link to="/services/market-linkage" className="hover:text-forest transition-colors leading-[1.8]">Market Linkage</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4 text-[#667069] text-[14px] font-normal">
              <li><Link to="/community" className="hover:text-forest transition-colors leading-[1.8]">Parivaar Community</Link></li>
              <li><Link to="/knowledge" className="hover:text-forest transition-colors leading-[1.8]">Knowledge Hub</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4 text-[#667069] text-[14px] font-normal">
              ...
              <li className="flex gap-2 items-center leading-[1.8]">
                ...
                <a href="mailto:info@agaate.in" className="hover:text-forest transition-colors">info@agaate.in</a>
              </li>
              <li className="flex gap-2 items-start leading-[1.8]">
                <MapPin className="w-3.5 h-3.5 text-forest shrink-0 mt-0.5" />
                <span>NH8, Kukrola,<br/>Gurugram, Haryana</span>
              </li>
            </ul>
          </div>
