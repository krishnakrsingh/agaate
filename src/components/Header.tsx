      ...
      >
        ...
        <div className="flex items-center justify-start flex-1">
          <Link to="/" className="flex items-center text-white transition-opacity hover:opacity-80">
            <img src="/logo.svg" alt="Agaate" className={`w-auto transition-all duration-500 ease-in-out ${scrolled ? 'h-6 md:h-7' : 'h-8 md:h-9 drop-shadow-md'}`} />
          </Link>
        </div>
        ...
        <div className={`flex items-center justify-end flex-1 transition-all duration-500 ease-in-out ${scrolled ? 'gap-4' : 'gap-6'}`}>
          ...
          <Link to="/contact" className={`group flex items-center gap-2 rounded-full font-body font-semibold transition-all duration-500 ease-in-out ${scrolled
            ...
            Contact Us <ArrowRight className={`transition-all duration-500 ease-in-out group-hover:translate-x-1 ${scrolled ? 'w-3.5 h-3.5 ml-0.5' : 'w-4 h-4 ml-1'}`} />
          </Link>
        </div>
      </header>
    </div>
