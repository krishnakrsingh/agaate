...
export const team: TeamMember[] = [
  ...
  },
  {
    id: "sunil-sharma",
    name: "Sunil Sharma",
    role: "Lead - Agri Input Sales & Farmer Engagement",
    focus: "Agri-Input Distribution, Field Advisory & Farmer Community Engagement",
    tag: "Sales & Farmer Engagement Lead",
    icon: Shield as Icon,
    image: "/team/sunil.png",
    bio: "Sunil leads Agri Input sales operations and grassroots farmer engagement across regional clusters, connecting growers with certified inputs, crop health solutions, and localized field support.",
    keyAch: [
      "Drove input sales growth and farmer adoption across regional clusters",
      "Organized on-field farmer training sessions and product demonstration plots",
      "Strengthened grower relationships and localized customer support networks",
    ],
    pub: "Grassroots farmer engagement strategies and agri-input retail distribution models (2026)",
    quote:
      "Direct grower relationships and access to the right agricultural inputs empower farmers to achieve healthy, high-yield harvests.",
  },
];
