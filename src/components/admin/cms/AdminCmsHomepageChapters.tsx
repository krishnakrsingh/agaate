        ...
        <div key={i} className="rounded-lg border p-3 space-y-2">
          <div className="grid gap-2 sm:grid-cols-3">
            ...
            <CmsBilingualField
              ...
              hi={stat.valueTextHi}
              onEn={(v) =>
                onChange(stats.map((s, idx) => (idx === i ? { ...s, valueTextEn: v } : s)))
              }
              onHi={(v) =>
                onChange(stats.map((s, idx) => (idx === i ? { ...s, valueTextHi: v } : s)))
              }
              disabled={disabled}
            />
          </div>
    ...
    <div className="space-y-6">
      ...
      {!dbConfigured && (
        <p className="text-xs text-amber-600">
          Database not configured — changes will not persist.
        </p>
      )}
              ...
              <div key={pillar.id} className="rounded-xl border bg-card shadow-sm">
                <div className="flex flex-col gap-3 border-b px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
                  <h2 className="text-sm font-semibold">
                    Pillar {pillar.number}: {pillar.id}
                  </h2>
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        updateChapters({
                          ...
                          pillars: pillars.map((p, idx) =>
                            idx === pi
                              ? { ...p, featuresEn: e.target.value.split("\n").filter(Boolean) }
                              : p,
                          ),
                        })
                      }
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        updateChapters({
                          ...
                          pillars: pillars.map((p, idx) =>
                            idx === pi
                              ? { ...p, featuresHi: e.target.value.split("\n").filter(Boolean) }
                              : p,
                          ),
                        })
                      }
                      ...
                      <CmsBilingualField
                        ...
                        onEn={(v) =>
                          updateChapters({
                            ...chapters,
                            pillars: pillars.map((p, idx) =>
                              idx === pi ? { ...p, viewLocationsLabelEn: v } : p,
                            ),
                          })
                        }
                        onHi={(v) =>
                          updateChapters({
                            ...chapters,
                            pillars: pillars.map((p, idx) =>
                              idx === pi ? { ...p, viewLocationsLabelHi: v } : p,
                            ),
                          })
                        }
                        disabled={!canEdit || loading}
            ...
            <div className="rounded-xl border bg-card shadow-sm">
              ...
              <div className="space-y-4 p-5">
                <CmsBilingualField
                  ...
                  onEn={(v) =>
                    updateChapters({ ...chapters, pillarMarket: { ...pillarMarket, badgeEn: v } })
                  }
                  onHi={(v) =>
                    updateChapters({ ...chapters, pillarMarket: { ...pillarMarket, badgeHi: v } })
                  }
                  disabled={!canEdit || loading}
                />
                <CmsBilingualField
                  ...
                  onEn={(v) =>
                    updateChapters({ ...chapters, pillarMarket: { ...pillarMarket, titleEn: v } })
                  }
                  onHi={(v) =>
                    updateChapters({ ...chapters, pillarMarket: { ...pillarMarket, titleHi: v } })
                  }
                  disabled={!canEdit || loading}
                />
                <CmsBilingualField
                  ...
                  onEn={(v) =>
                    updateChapters({
                      ...chapters,
                      pillarMarket: { ...pillarMarket, descriptionEn: v },
                    })
                  }
                  onHi={(v) =>
                    updateChapters({
                      ...chapters,
                      pillarMarket: { ...pillarMarket, descriptionHi: v },
                    })
                  }
                  disabled={!canEdit || loading}
                  multiline
                ...
                <StatEditor
                  ...
                  onChange={(stats) =>
                    updateChapters({ ...chapters, pillarMarket: { ...pillarMarket, stats } })
                  }
                  disabled={!canEdit || loading}
                />
                <CmsBilingualField
                  ...
                  onEn={(v) =>
                    updateChapters({
                      ...chapters,
                      pillarMarket: { ...pillarMarket, ctaLabelEn: v },
                    })
                  }
                  onHi={(v) =>
                    updateChapters({
                      ...chapters,
                      pillarMarket: { ...pillarMarket, ctaLabelHi: v },
                    })
                  }
                  disabled={!canEdit || loading}
                />
                <CmsImageField
                  ...
                  onChange={(url) =>
                    updateChapters({
                      ...chapters,
                      pillarMarket: { ...pillarMarket, imageUrl: url },
                    })
                  }
                  disabled={!canEdit || loading}
                />
            ...
            <div className="rounded-xl border bg-card shadow-sm">
              ...
              <div className="space-y-4 p-5">
                <CmsBilingualField
                  ...
                  onEn={(v) =>
                    updateChapters({ ...chapters, appChapter: { ...appChapter, badgeEn: v } })
                  }
                  onHi={(v) =>
                    updateChapters({ ...chapters, appChapter: { ...appChapter, badgeHi: v } })
                  }
                  disabled={!canEdit || loading}
                />
                <CmsBilingualField
                  ...
                  onEn={(v) =>
                    updateChapters({ ...chapters, appChapter: { ...appChapter, titleEn: v } })
                  }
                  onHi={(v) =>
                    updateChapters({ ...chapters, appChapter: { ...appChapter, titleHi: v } })
                  }
                  disabled={!canEdit || loading}
                />
                <CmsBilingualField
                  ...
                  onEn={(v) =>
                    updateChapters({ ...chapters, appChapter: { ...appChapter, descriptionEn: v } })
                  }
                  onHi={(v) =>
                    updateChapters({ ...chapters, appChapter: { ...appChapter, descriptionHi: v } })
                  }
                  disabled={!canEdit || loading}
                  multiline
                />
                <StatEditor
                  ...
                  onChange={(stats) =>
                    updateChapters({ ...chapters, appChapter: { ...appChapter, stats } })
                  }
                  disabled={!canEdit || loading}
                />
                <div className="space-y-2">
              ...
              <div className="space-y-4 p-5">
                <CmsBilingualField
                  ...
                  onEn={(v) =>
                    updateChapters({
                      ...chapters,
                      closingChapter: { ...closingChapter, badgeEn: v },
                    })
                  }
                  onHi={(v) =>
                    updateChapters({
                      ...chapters,
                      closingChapter: { ...closingChapter, badgeHi: v },
                    })
                  }
                  disabled={!canEdit || loading}
                />
                <CmsBilingualField
                  ...
                  onEn={(v) =>
                    updateChapters({
                      ...chapters,
                      closingChapter: { ...closingChapter, titleEn: v },
                    })
                  }
                  onHi={(v) =>
                    updateChapters({
                      ...chapters,
                      closingChapter: { ...closingChapter, titleHi: v },
                    })
                  }
                  disabled={!canEdit || loading}
                />
                <CmsBilingualField
                  ...
                  onEn={(v) =>
                    updateChapters({
                      ...chapters,
                      closingChapter: { ...closingChapter, descriptionEn: v },
                    })
                  }
                  onHi={(v) =>
                    updateChapters({
                      ...chapters,
                      closingChapter: { ...closingChapter, descriptionHi: v },
                    })
                  }
                  disabled={!canEdit || loading}
                  multiline
