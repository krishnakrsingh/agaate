        ...
        <div className="space-y-3 text-left mb-10">
          <div className="flex items-center gap-2.5">
            ...
            <p className="font-mono text-[11px] font-bold uppercase tracking-[0.18em] text-[#5d7d37]">
              05 · Frequently Asked Agronomy Questions
            </p>
          </div>
            ...
            return (
              <div key={f.q}>
                <button
                  ...
                  className="cursor-pointer flex w-full items-center justify-between gap-4 py-5 sm:py-6 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#143d31]/30"
                >
