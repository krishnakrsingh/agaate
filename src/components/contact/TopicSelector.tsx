        ...
        {options.map((topic) => {
          ...
          return (
            <button
              ...
              className={cn(
                "w-full rounded-2xl border p-4 text-left transition-all duration-300 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#143d31]/30",
                selected
                  ? "border-[#143d31] bg-[#143d31] text-white shadow-md shadow-[#143d31]/15 -translate-y-0.5"
                  : "border-[#143d31]/12 bg-white text-[#143d31] hover:border-[#143d31]/30 hover:bg-[#f4f8f5]/60",
              )}
            >
