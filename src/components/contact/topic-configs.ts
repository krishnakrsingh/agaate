...
const GENERAL_TOPIC_CONFIG: TopicFormConfig = {
  id: "general",
  ...
  notesPlaceholderEn:
    "Describe leaf curling, yellowing, pest attack, fertigation schedule needs, or soil conditions...",
  notesPlaceholderHi:
    "पत्ती मुड़ना, पीलापन, कीट प्रकोप, स्प्रे शेड्यूल या मिट्टी संबंधी प्रश्न बताएं...",
  showFileUpload: true,
...
export const TOPIC_FORM_CONFIGS: Record<string, TopicFormConfig> = {
  nursery: {
    ...
    field2OptionsEn: [
      "2,000 – 5,000 Saplings",
      "5,000 – 20,000 Saplings",
      "20,000 – 50,000 Saplings",
      "50,000+ Commercial Order",
    ],
    field2OptionsHi: [
      "2,000 – 5,000 पौधे",
      "5,000 – 20,000 पौधे",
      "20,000 – 50,000 पौधे",
      "50,000+ व्यावसायिक ऑर्डर",
    ],
    ...
    notesPlaceholderEn:
      "e.g. Need 10,000 seedlings for mid-August transplanting, open to variety recommendation...",
  ...
  bigfarm: {
    ...
    field2OptionsEn: [
      ...
      "Automated Drip & Fertigation",
      "Polyhouse / Net-house Facility",
      "High-Density Fruit Orchard",
    ],
    field2OptionsHi: [
      "संपूर्ण टर्नकी फार्म सेटअप",
      "ऑटोमेटेड ड्रिप व फर्टिगेशन",
      "पॉलीहाउस / नेट-हाउस सुविधा",
      "सघन बागवानी (ऑर्चर्ड)",
    ],
    ...
    notesPlaceholderEn:
      "Mention borewell water availability, boundary fencing status, or planned launch date...",
  ...
  carbon: {
    ...
    field2OptionsEn: [
      ...
      "Bio-Fertilizer & Organic Inputs",
      "Flood Irrigation (Planning Switch)",
    ],
    field2OptionsHi: [
      "AWD / ड्रिप सिंचाई",
      "जीरो-टिलेज / सीधी बिजाई",
      "जैविक खाद व बायो-इनपुट्स",
      "पारंपरिक खुला पानी (बदलने के इच्छुक)",
    ],
    ...
    notesPlaceholderEn:
      "e.g. Currently growing Paddy & Wheat across 30 acres under direct seeded rice...",
  ...
  wholesale: {
    ...
    field1OptionsEn: [
      "Agri Retailer / Dealer",
      "FPO / Farmer Cooperative",
      "Commercial Farm Estate",
      "Institutional Contractor",
    ],
    field1OptionsHi: [
      "खाद-बीज विक्रेता / डीलर",
      "FPO / किसान उत्पादक कंपनी",
      "बड़ा कमर्शियल फार्म",
      "संस्थागत खरीदार",
    ],
    ...
    field2OptionsEn: [
      "Certified Seeds & Hybrid Trays",
      "Fertilizers & Biocures",
      "Mulch Film, Drip & Bamboo Staking",
      "Full Agri-Mall Range",
    ],
    field2OptionsHi: [
      "प्रमाणित बीज व पौध ट्रे",
      "खाद, कीटनाशक व बायोक्योर",
      "मल्चिंग फिल्म, ड्रिप व बांस",
      "संपूर्ण मॉल उत्पाद रेंज",
    ],
  ...
  agripark: {
    ...
    field1OptionsEn: [
      "Individual Progressive Farmer",
      "Farmer Delegation / FPO Group",
    ...
    field1OptionsHi: [
      "प्रगतिशील किसान",
      "किसान दल / एफपीओ समूह",
      "कृषि विश्वविद्यालय / छात्र",
      "कॉर्पोरेट / उद्योग प्रतिनिधि",
    ],
    field2LabelEn: "Group Size",
    field2LabelHi: "सदस्यों की संख्या",
    field2OptionsEn: [
      "1 – 2 People (Individual Tour)",
      "3 – 10 People (Farmer Group)",
      "10 – 30+ People (Bus / Delegation)",
    ],
    field2OptionsHi: [
      "1 – 2 लोग (व्यक्तिगत दौरा)",
      "3 – 10 लोग (किसान समूह)",
      "10 – 30+ लोग (बस / प्रतिनिधिमंडल)",
    ],
    ...
    notesPlaceholderEn:
      "e.g. Visiting next Saturday morning, interested in nursery tech & drip zones...",
    notesPlaceholderHi:
      "उदा. अगले शनिवार सुबह आएंगे, नर्सरी तकनीक और ड्रिप डेमो देखना चाहते हैं...",
    showFileUpload: false,
    buttonLabelEn: "Book Agri Park Guided Tour",
    buttonLabelHi: "एग्री पार्क टूर बुक करें",
  },
  general: GENERAL_TOPIC_CONFIG,
  franchise: {
    id: "franchise",
    ...
    field1OptionsEn: [
      "Agaate Kisan Mall (Retail Store)",
      "Smart Nursery Distribution Unit",
      "Integrated Agri Hub (Mall + Nursery)",
    ],
    field1OptionsHi: [
      "अगाते किसान मॉल (रिटेल केंद्र)",
      "स्मार्ट नर्सरी डिस्ट्रीब्यूशन यूनिट",
      "इंटीग्रेटेड एग्री हब (मॉल + नर्सरी)",
    ],
    ...
    notesPlaceholderEn:
      "Mention if you have a roadside shop (500-1500 sq ft), land, or existing agri business experience...",
    notesPlaceholderHi:
      "रोड-साइड दुकान (500-1500 वर्ग फीट), जमीन या मौजूदा कृषि व्यापार का अनुभव बताएं...",
    showFileUpload: false,
...
export function getTopicConfig(topicId: string): TopicFormConfig {
  return TOPIC_FORM_CONFIGS[topicId] ?? GENERAL_TOPIC_CONFIG;
}
