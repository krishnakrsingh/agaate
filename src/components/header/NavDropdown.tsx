...
export function NavDropdown({ subLinks, isOpen, currentLang }: NavDropdownProps) {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="pointer-events-auto absolute left-1/2 top-full z-50 w-[580px] -translate-x-1/2 pt-3">
          <motion.div
            initial="hidden"
            animate="visible"
            exit="exit"
            ...
            className="overflow-hidden rounded-[24px] border border-slate-200/80 bg-white/98 p-4 text-slate-900 shadow-[0_25px_60px_-15px_rgba(13,40,32,0.16),0_0_0_1px_rgba(0,0,0,0.03)] backdrop-blur-2xl"
          >
                ...
                return (
                  ...
                  >
                    <Link
                      ...
                      className="group relative flex items-start gap-3 overflow-hidden rounded-[14px] p-2.5 transition-all duration-200 hover:bg-slate-50"
                    >
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[12px] border border-slate-200/80 bg-slate-100/80 text-[#0d2a21] shadow-[0_1px_2px_rgba(0,0,0,0.03)] transition-all duration-300 group-hover:-rotate-2 group-hover:scale-105 group-hover:border-[#0d2a21] group-hover:bg-[#0d2a21] group-hover:text-[#a3e635] group-hover:shadow-md">
                        {SubIcon && (
                          <SubIcon
                      ...
                      <div className="flex min-w-0 flex-1 flex-col pt-0.5">
                        <div className="flex items-center justify-between">
                          ...
                          <ArrowRight className="h-3 w-3 -translate-x-1.5 text-[#0d2a21] opacity-0 transition-all duration-200 group-hover:translate-x-0 group-hover:opacity-100" />
                        </div>
                        {subDesc && (
            ...
            {/* Dropdown Footer */}
            <div className="mt-2.5 flex items-center justify-between rounded-[16px] border border-slate-200/70 bg-slate-50/90 p-3 shadow-xs">
              ...
              <Link
                ...
                className="group/btn flex shrink-0 items-center gap-1.5 rounded-[11px] bg-[#0d2a21] px-4 py-2 text-[11.5px] font-bold text-white shadow-sm transition-all duration-200 hover:bg-[#14332b] hover:shadow-md active:scale-[0.98]"
              >
