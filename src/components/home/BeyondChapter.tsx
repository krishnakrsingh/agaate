  ...
  return (
    <section className="bg-[#DDEBCF] px-6 py-24 md:px-10 md:py-32 lg:px-12 lg:py-40">
      <div className="mx-auto max-w-[1400px]">
        ...
        <h2 className="mt-6 max-w-4xl font-serif text-[clamp(3rem,5.5vw,5.9rem)] leading-[0.91] tracking-[-0.06em] text-[#143D31]">{t("beyond.title")}</h2>
        <div className="mt-16">
          {[
            "/services/farm-tech",
            ...
            >
              ...
              <div>
                ...
                <p className="mt-3 max-w-xl text-[15px] leading-7 text-[#52685A]">{t(`beyond.items.${index}.desc` as any)}</p>
              </div>
