      ...
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="mt-16 grid lg:grid-cols-12 lg:items-end lg:gap-16">
          <div className="lg:col-span-6">
            <ImagePlaceholder
              label={t("mall.placeholderLabel")}
              detail={t("mall.placeholderDetail")}
        ...
        <div className="mt-16 grid overflow-hidden bg-[#DDEBCF] md:grid-cols-[1fr_1.65fr]">
          <div className="p-7 md:p-10">
            ...
            <p className="mt-12 font-serif text-[clamp(2rem,3.5vw,3.4rem)] leading-[0.98] tracking-[-0.045em] text-[#143D31]">{t("mall.title2")}</p>
          </div>
          <img
            src={seedsImage}
