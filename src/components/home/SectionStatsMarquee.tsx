...
export default function SectionStatsMarquee() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full bg-[#f4f8f5] py-1.5 sm:py-2 md:py-2.5 text-[#143d31] overflow-hidden"
    >
      <motion.div
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, transparent 0%, rgba(20, 61, 49, 0.22) 10%, rgba(20, 61, 49, 0.22) 90%, transparent 100%)",
          }}
        />
        ...
        <div className="hidden md:block">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, transparent 0%, rgba(20, 61, 49, 0.18) 10%, rgba(20, 61, 49, 0.18) 90%, transparent 100%)",
            }}
          />
              ...
              <React.Fragment key={startIndex}>
                ...
                {!isLastRow && (
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to right, transparent 0%, rgba(20, 61, 49, 0.16) 8%, rgba(20, 61, 49, 0.16) 92%, transparent 100%)",
                    }}
                  />
                )}
              </React.Fragment>
