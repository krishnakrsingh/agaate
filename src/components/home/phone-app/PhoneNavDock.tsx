...
export function PhoneNavDock({ activeTab, onChangeTab }: PhoneNavDockProps) {
  ...
  return (
    <div className="relative shrink-0 border-t border-[#143d31]/8 bg-white px-3 pt-2 pb-2 shadow-[0_-4px_15px_-10px_rgba(0,0,0,0.05)] rounded-b-[2.1rem]">
      ...
      {/* Flagship Home Indicator Bar */}
      <div className="mt-1.5 flex justify-center">
        <div className="h-1 w-24 rounded-full bg-[#143d31]/20" />
      </div>
    </div>
  );
}
