...
export default function PillarMarket() {
  ...
  return (
    <section
      ref={sectionRef}
      id="pillar-market"
      className="sticky top-0 z-40 min-h-screen flex items-center justify-center bg-[#f4f8f5] py-20 sm:py-24 lg:py-28 border-t border-[#143d31]/10 rounded-t-[32px] sm:rounded-t-[44px] shadow-[0_-20px_50px_rgba(20,61,49,0.12)] overflow-hidden"
    >
        ...
        <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
            ...
            <TiltCard maxTilt={6} glare={false} className="w-full">
              ...
              >
                <img
                  ...
                  alt="Guaranteed Buyback & Carbon Credits"
          ...
          >
            ...
            <h2 className="font-display text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-[#143d31] leading-[1.15]">
              Guaranteed Buyback & Carbon Credits
            </h2>
            ...
            <div className="my-6 border-y border-[#143d31]/12 py-4 grid grid-cols-3 gap-2">
              ...
              <div className="text-left border-l border-[#5d7d37]/40 pl-3">
                <p className="font-display text-xl sm:text-2xl font-extrabold text-[#143d31]">
                  <CountUp to={10} prefix="₹" suffix=" Cr+" />
                </p>
                <p className="font-mono text-[10px] font-bold text-[#5d7d37] uppercase tracking-wider mt-0.5">
                  Farmer Value
                </p>
            ...
            {/* CTA Button */}
            <div>
              <MagneticButton strength={0.25} as="a" href="/services#market-linkage">
