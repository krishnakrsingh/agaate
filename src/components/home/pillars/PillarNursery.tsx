...
export default function PillarNursery() {
  ...
  return (
    <section
      ref={sectionRef}
      id="pillar-nursery"
      className="sticky top-0 z-20 min-h-screen flex items-center justify-center bg-[#f4f8f5] py-20 sm:py-24 lg:py-28 border-t border-[#143d31]/10 rounded-t-[32px] sm:rounded-t-[44px] shadow-[0_-20px_50px_rgba(20,61,49,0.12)] overflow-hidden"
    >
