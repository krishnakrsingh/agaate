...
import { MALL_SUPPLY_CHAIN } from "./data";
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 space-y-12">
        ...
        <Reveal variant="fade-up" className="space-y-4">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            >
              {isHindi
                ? "निर्माता कंपनियों से सीधे खेत के गेट तक की सुरक्षित यात्रा"
                : "From partner labs directly to your field gate"}
            </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {MALL_SUPPLY_CHAIN.map((step, idx) => {
