...
export default memo(function SectionHero({
  ...
  return (
    <section ref={sectionRef} id="hero" className="relative w-full h-[100dvh] p-2 md:p-2.5 bg-[#f4f8f5]">
      <div ref={containerRef} className="relative w-full h-full overflow-hidden rounded-[16px] bg-[#f4f8f5]">
        {/* Background Video */}
        <video
          ref={videoRef}
