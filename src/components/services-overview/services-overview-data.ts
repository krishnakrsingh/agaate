...
export const SERVICES_EN: ServiceItem[] = [
  ...
  },
  {
    ...
    category: "nursery-inputs",
    desc: "500+ QR-verified seeds, organic biologicals, water-soluble fertigation nutrients, and custom drip kits straight from 50+ manufacturer partners.",
    tag: "Input Commerce",
    badgeStat: "500+",
...
export const SERVICES_HI: ServiceItem[] = [
  ...
  },
  {
    ...
    category: "nursery-inputs",
    desc: "50+ शीर्ष कंपनियों से 500+ क्यूआर-प्रमाणित बीज, जैविक पोषण और आधुनिक ड्रिप सामग्री सीधे किफायती दामों पर।",
    tag: "इनपुट कॉमर्स",
    badgeStat: "500+",
...
export const IMPACT_STATS_EN = [
  ...
  { to: 100, suffix: "%", label: "QC verified genuine inputs" },
