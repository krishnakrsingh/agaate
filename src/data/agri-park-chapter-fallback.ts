...
export const AGRI_PARK_CHAPTER_FALLBACK: HomeAgriParkChapterContent = {
  badgeEn: "5-Acre Agri Park",
  badgeHi: "5-एकड़ एग्री पार्क",
  titleEn: "5-Acre Living Proving Ground for Modern Farming",
  titleHi: "5 एकड़ का जीवित फार्म — हर समाधान जमीन पर प्रमाणित",
  descriptionEn:
  ...
  stats: [
    { prefixEn: "", prefixHi: "", numValue: 5, suffixEn: " Acres", suffixHi: " एकड़", valueTextEn: "", valueTextHi: "", labelEn: "Live Farm Proving", labelHi: "जीवित रिसर्च फार्म" },
    { prefixEn: "", prefixHi: "", numValue: 98, suffixEn: "%", suffixHi: "%", valueTextEn: "", valueTextHi: "", labelEn: "Sapling Survival", labelHi: "नर्सरी जमाव दर" },
    { prefixEn: "", prefixHi: "", numValue: 2000, suffixEn: "+", suffixHi: "+", valueTextEn: "", valueTextHi: "", labelEn: "Farmers Trained", labelHi: "प्रशिक्षित किसान" },
  ],
  checklistEn: [
  ...
  bookVisitLabelEn: "Book Farm Visit",
  bookVisitLabelHi: "फार्म विजिट बुक करें",
  watchTourLabelEn: "Watch Video Tour",
