...
export const CONTACT_PAGE_FALLBACK: ContactPageContent = {
  ...
  consultationTopics: [
    ...
    {
      id: "franchise",
      labelEn: "Agaate Franchise Partnership",
      labelHi: "अगाते फ्रेंचाइजी पार्टनरशिप",
      descEn: "Start an Agaate Kisan Mall retail hub or Nursery franchise in your territory.",
      descHi: "अपने क्षेत्र में अगाते किसान मॉल या नर्सरी फ्रेंचाइजी केंद्र शुरू करें।",
      iconKey: "handshake",
    },
  ],
