...
export const SHORTS_DATA_EN: FarmerShortItem[] = [
  {
    ...
    quote: "Agaate's Bio-Boosted nursery plug seedlings gave us 98% field survival. Sowing losses dropped to zero.",
  ...
  },
  {
    ...
    quote: "Biological root treatments and stage fertigation stopped bacterial wilt and delivered export-grade bell peppers.",
  ...
  },
  {
    ...
    quote: "Uniform fruit size and deep red flesh with 13° Brix sugar levels. Sold our harvest at top mandi rates.",
  ...
  },
  {
    ...
    acres: "15 Acres",
    crop: "Tomato (Tamatar)",
    quote: "Trellising staking and IPM solar traps protected our crop during peak blight weather without pesticide burn.",
  ...
  },
  {
    ...
    quote: "Within just 7 days of transplanting, root anchoring and new leaf flushes were visibly double ordinary seedlings.",
  ...
  },
  {
    ...
    quote: "Automated drip irrigation saved 60% water and 2 hours of daily labour while dosing nutrients directly to the root zone.",
  ...
  },
  {
    ...
    quote: "Lure traps trapped fruit flies and borers before they could lay eggs. Reduced chemical sprays by 4 rounds.",
  ...
  },
  {
    ...
    quote: "Getting 100% original inputs straight from manufacturers at fair wholesale rates with agronomist guidance.",
...
export const SHORTS_DATA_HI: FarmerShortItem[] = [
  {
    ...
    quote: "अगाते की बायो-बूस्टेड नर्सरी पौध का 98% जमाव रहा। खेत में रोपाई के बाद एक भी पौधा नहीं सूखा।",
    thumbnail: "/videos/posters/mirch-paudh-kisan.webp",
    videoUrl: "/videos/shorts/mirch-paudh-kisan.mp4",
    badge: "98% पौध जमाव"
  },
  {
    ...
    acres: "12 एकड़",
    crop: "शिमला मिर्च",
    quote: "बायो-दवाओं और सही ड्रिप फर्टीगेशन से उकठा (Wilt) रोग पूरी तरह रुक गया और शानदार एक्सपोर्ट-ग्रेड शिमला मिर्च मिली।",
    thumbnail: "/videos/posters/shimla-mirch-kisan.webp",
    videoUrl: "/videos/shorts/shimla-mirch-kisan.mp4",
    badge: "रोग मुक्त फसल"
  },
  ...
  },
  {
    ...
    acres: "15 एकड़",
    crop: "टमाटर (Tamatar)",
    quote: "स्टेकिंग व सोलर ट्रैप्स की तकनीक से बारिश के मौसम में भी टमाटर की बेल सुरक्षित रही और कोई स्प्रे नुकसान नहीं हुआ।",
    thumbnail: "/videos/posters/tomato-farming-reel.webp",
    videoUrl: "/videos/shorts/tomato-farming-reel.mp4",
    badge: "सुरक्षित बेल"
  },
  {
    ...
    quote: "रोपाई के सिर्फ 7 दिन के अंदर सफेद जड़ों का जाल और नए पत्तों का विकास आम पौध से दोगुना दिखा।",
    thumbnail: "/videos/posters/7-din-fark.webp",
    videoUrl: "/videos/shorts/7-din-fark.mp4",
    badge: "7 दिन में असर"
  },
  ...
  },
  {
    ...
    quote: "ट्रैप्स ने फल मक्खी और सुंडी को अंडे देने से पहले ही पकड़ लिया। 4 राउंड के रासायनिक स्प्रे बच गए।",
    thumbnail: "/videos/posters/traps-intro-reel.webp",
    videoUrl: "/videos/shorts/traps-intro-reel.mp4",
  ...
  },
  {
    ...
    quote: "किसान मॉल से सीधे कंपनी का 100% असली बीज और खाद उचित दाम पर मिली, साथ में कृषि डॉक्टर की सलाह।",
    thumbnail: "/videos/posters/farmer-kisan-mall.webp",
    videoUrl: "/videos/shorts/farmer-kisan-mall.mp4",
