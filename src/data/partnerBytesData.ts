...
export const PARTNER_BYTES: Record<string, PartnerByteItem> = {
  netafim: {
    ...
    summary:
      "How Netafim precision drip and automated fertigation systems increase nutrient absorption by 40% while slashing water consumption across Haryana vegetable clusters.",
    summaryHi:
      "नेटाफिम ड्रिप और ऑटोमेटेड फर्टीगेशन से हरियाणा में सब्जी किसानों की 40% खाद और 60% पानी की बचत होती है।",
  ...
  bayer: {
    ...
    summary:
      "Authentic Bayer & Seminis seed genetics tailored for North Indian sub-tropical climate, ensuring high germination and robust field performance.",
    summaryHi:
      "उत्तर भारत की जलवायु के अनुसार बायर और सेमिनिस के प्रमाणित हाइब्रिड बीजों की उच्च जमाव दर और रोग प्रतिरोधक क्षमता।",
  ...
  coromandel: {
    ...
    summary:
      "Coromandel specialized water-soluble fertilizers and organic bio-boosters custom-prescribed for tomato, chilli, and cucurbit crops.",
    summaryHi:
      "कोरोमंडल के घुलनशील उर्वरक और जैविक पोषण से टमाटर, मिर्च और बेलदार फसलों के संपूर्ण विकास का वैज्ञानिक तरीका।",
  ...
  syngenta: {
    ...
    summary:
      "Guaranteed seed authentication and targeted protection spray schedules minimizing residue and maximizing market yield.",
    summaryHi:
      "100% असली बीजों की पहचान और न्यूनतम रासायनिक स्प्रे में अधिकतम सब्जी उत्पादन के नियम।",
  ...
  koppert: {
    ...
    summary:
      "Beneficial microorganisms and bio-agents that suppress soil-borne pathogens and root rot naturally without chemical resistance.",
    summaryHi:
      "कॉपरट के जैविक बायो-एजेंट्स जो बिना किसी हानिकारक केमिकल के मिट्टी के रोगों और उकठा से फसल को बचाते हैं।",
  ...
  "t-stanes": {
    ...
    summary:
      "Century-old botanical extraction and bio-inoculation science revitalizing soil microbiology and boosting root capillary development.",
    summaryHi:
      "टी. स्टेन्स के 100+ वर्षों के वैज्ञानिक बायो-फर्टिलाइजर से खेत की मिट्टी को जीवित और उपजाऊ बनाने का अनुभव।",
