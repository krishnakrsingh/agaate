import { fetchHomeCms, fetchKisaanMallLanding, fetchKisaanMallPage, fetchCareersPage, fetchSiteContact, fetchAboutPage, fetchContactPage } from "@/server/cms-queries";
