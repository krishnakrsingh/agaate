      ...
      <div className="py-24 px-6 lg:px-12 max-w-7xl mx-auto w-full flex-grow space-y-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-6 space-y-8 text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-border">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-forest/65 leading-relaxed mt-1">
                    Bi-weekly flyover flights evaluating NDVI leaf indices to target nitrogen
                    dosing.
                  </p>
                </div>
              </div>
            ...
            <div
              className={`p-6 border rounded-2xl flex gap-4 text-xs font-sans items-start ${advice.color}`}
            >
          ...
          <div className="lg:col-span-6 bg-bone rounded-[2.5rem] border border-border p-8 text-left space-y-6 shadow-sm">
            <div className="flex justify-between items-center">
              <div>
                ...
                <h3 className="font-serif text-3xl text-forest-deep font-bold">{nodeActive}</h3>
              </div>
            ...
            <div className="bg-card border border-border rounded-2xl p-4 shadow-sm">
              <span className="text-[10px] font-mono text-forest/45 uppercase block mb-3 font-semibold">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs font-mono">
                <span className="text-forest/60 uppercase font-semibold">
                  Simulate Soil moisture tension
                </span>
            ...
            <div className="grid grid-cols-3 gap-3 text-center text-xs font-mono">
              <div className="bg-card p-3.5 border border-border rounded-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <p className="text-forest/75 text-sm leading-relaxed">
                Bi-weekly drone scans evaluate the Normalized Difference Vegetation Index (NDVI). By
                analyzing near-infrared light reflection, we generate crop nitrogen deficiency maps,
                allowing localized dosing instead of wasting expensive fertilizer across healthy
                areas.
              </p>
              <button
            ...
            <div className="bg-bone rounded-[2.5rem] border border-border p-8 min-h-[300px] flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col justify-between h-full space-y-6">
                <div className="flex justify-between items-center font-mono text-[10px] text-forest/50">
                  ...
                  <span>
                    STATUS: {isPlayingFlight ? "FLIGHT SIMULATION LIVE" : "MISSION WAITING"}
                  </span>
                </div>
                ...
                {isPlayingFlight ? (
                  <div className="space-y-4 animate-in fade-in">
                    ...
                    <span className="text-center block text-xs font-mono text-forest font-bold">
                      Scanning Field Grids... {flightProgress}%
                    </span>
                  </div>
                ) : (
                  <div className="text-center py-6 space-y-4">
                    ...
                    <h4 className="font-serif text-2xl text-forest-deep font-bold">
                      Drone Diagnostics Standby
                    </h4>
                    <p className="text-xs text-forest/65 max-w-xs mx-auto">
                      Click the trigger button to simulate compiling leaf reflectance indices and
                      diagnosing nitrogen patches.
                    </p>
                  </div>
                )}

                <div className="pt-4 border-t border-border/50 grid grid-cols-2 gap-4 text-xs font-mono">
                  <div>
